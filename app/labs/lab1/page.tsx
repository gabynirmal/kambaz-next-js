    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Mash 4 overripe bananas</li>
          <li>
            Mix in canola oil, sugar, flour, salt, baking soda, and chocolate
            chips
          </li>
          <li>Pour into bread baking pan</li>
          <li>Bake for 60 mins at 350 degrees</li>
          <li>Let sit for 30 mins before serving</li>
          <li>Enjoy!</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Wonder</li>
          <li>This Motherless Land</li>
          <li>Sky Full of Elephants</li>
        </ul>
      </div>
      <div id="wd-tables">
        <h4>Table Tag</h4>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          {/* received a console error for setting children on <textarea> instead of using the defaultValue or value prop */}
          <textarea
            id="wd-textarea"
            cols={30}
            rows={10}
